...
if album in slownik.keys():
    ...
    print(f'Wykonawcą albumu {album} jest {slownik[album]}')
else:
    print('Brak danych')
...
# MENU
# https://stackoverflow.com/questions/24645867/python-console-menu-using-a-dictionary rozbudowane
if tryb == 'W':
